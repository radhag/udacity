...
def process_song_file(cur, filepath):
     """Reads songs log file ine by line, selects desired fields and inserts them into song and artist tables.
        Parameters:
...
def process_log_file(cur, filepath):
    """Reads user activity log file line by line, filters by NexSong, selects needed fields, transforms them and inserts
